...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(74)(module), (function() { return this; }()), __webpack_require__(75)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VirtualNode = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pathParser = __webpack_require__(84);

	var _pathParser2 = _interopRequireDefault(_pathParser);

	var _searchParams = __webpack_require__(85);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routerToObservable = __webpack_require__(67);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _linkOnClick = __webpack_require__(66);

	var linkInterceptorPlugin = function linkInterceptorPlugin() {
	    return function (router) {
	        var listener = function listener(evt) {
	            if ((0, _linkOnClick.shouldInterceptEvent)(router)(evt)) {
	                (0, _linkOnClick.onClick)(router)(evt);
	            }
	        };
	...
	exports['default'] = linkInterceptorPlugin;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cycleDom = __webpack_require__(12);

	var LinkFactory = function LinkFactory(router) {
	    return function (route) {
	        return (0, _cycleDom.a)({
	...
	function Nav(sources) {
	    ...
	    var Link = LinkFactory(routerSource);

	    var nav$ = routerSource.route$.map(function (route) {
	        return (0, _cycleDom.h)('nav', [Link('a'), Link('a.a'), Link('a.b'), Link('a.c'), Link('b'), Link('b.a'), Link('b.b'), Link('b.c')]);
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _router5 = __webpack_require__(83);

	var _router52 = _interopRequireDefault(_router5);

	var _router5PluginsBrowser = __webpack_require__(87);

	var _router5PluginsBrowser2 = _interopRequireDefault(_router5PluginsBrowser);

	var _cycleRouter5LinkInterceptorPlugin = __webpack_require__(65);

	var _cycleRouter5LinkInterceptorPlugin2 = _interopRequireDefault(_cycleRouter5LinkInterceptorPlugin);
	...
	var configureRouter = function configureRouter(routes) {
	    return (0, _router52['default'])(routes, {
	        ...
	        useHash: true
	    })).usePlugin((0, _cycleRouter5LinkInterceptorPlugin2['default'])());
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cycleRouter5Driver = __webpack_require__(64);

	var _cycleRouter5Driver2 = _interopRequireDefault(_cycleRouter5Driver);
	...
	var _componentsNav = __webpack_require__(68);

	var _componentsNav2 = _interopRequireDefault(_componentsNav);

	var _randomcolor = __webpack_require__(72);

	var _randomcolor2 = _interopRequireDefault(_randomcolor);

	var randomBgColor = function randomBgColor() {
	    return { backgroundColor: (0, _randomcolor2['default'])() };
	};
	...
	function main(sources) {
	    ...
	    var main$ = sources.router.routeNode$('').flatMapLatest(function (route) {
	        var childNode = route.name.split('.')[0];

	        var routeElm = (0, _cycleDom.div)({ className: 'item', style: randomBgColor() }, childNode);

	        var Route = function Route(segment) {
	            return (0, _cycleDom.div)({ className: 'column' }, [routeElm, segment ? (0, _cycleDom.div)({ className: 'item', style: randomBgColor() }, segment) : (0, _cycleDom.div)({ className: 'item' }, '_')]);
	        };

	        return sources.router.routeNode$(childNode).map(function (route) {
	            return Route(route.name.split('.')[1]);
	        });
	    });

	    var vtree$ = _rx2['default'].Observable.combineLatest(nav$, main$, function (nav, main) {
	        return (0, _cycleDom.div)('.box', [(0, _cycleDom.h)('aside', nav), (0, _cycleDom.h)('main', main)]);
	    });
	...
	_cycleCore2['default'].run(main, {
	    ...
	    router: (0, _cycleRouter5Driver2['default'])((0, _createRouter2['default'])(_routes2['default']))
	});
...
/***/ function(module, exports) {
	...
	exports['default'] = [_extends({}, a, { children: [a, b, c] }), _extends({}, b, { children: [a, b, c] })];
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routerLifecycle = __webpack_require__(80);
	...
	var _middleware = __webpack_require__(76);

	var _middleware2 = _interopRequireDefault(_middleware);

	var _plugins = __webpack_require__(78);

	var _plugins2 = _interopRequireDefault(_plugins);

	var _routeLifecycle = __webpack_require__(79);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createRouter = __webpack_require__(82);
