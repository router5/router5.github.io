...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BaseLink = __webpack_require__(198);

	var _BaseLink2 = _interopRequireDefault(_BaseLink);

	var _routeNode = __webpack_require__(200);

	var _routeNode2 = _interopRequireDefault(_routeNode);

	var _RouterProvider = __webpack_require__(199);

	var _RouterProvider2 = _interopRequireDefault(_RouterProvider);

	var _withRoute = __webpack_require__(201);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pathParser = __webpack_require__(223);

	var _pathParser2 = _interopRequireDefault(_pathParser);

	var _searchParams = __webpack_require__(224);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactRouter5 = __webpack_require__(30);
	...
	var Compose = (function (_Component) {
	    ...
	    function Compose(props, context) {
	        ...
	        _get(Object.getPrototypeOf(Compose.prototype), 'constructor', this).call(this, props, context);
	        this.state = {
	            title: undefined,
	            message: undefined
	        };
	    ...
	    _createClass(Compose, [{
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement('input', { name: 'title', value: title, onChange: this.updateTitle }),
	                _react2['default'].createElement('textarea', { name: 'message', value: message, onChange: this.updateMessage }),
	...
	exports['default'] = (0, _reactRouter5.routeNode)('compose', true)(Compose);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InboxList = __webpack_require__(119);
	...
	function Inbox(props) {
	    ...
	    return _react2['default'].createElement(
	        'div',
	        { className: 'inbox' },
	        _react2['default'].createElement(_InboxList2['default'], { emails: (0, _api.getEmails)() }),
	...
	exports['default'] = (0, _reactRouter5.routeNode)('inbox')(Inbox);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InboxItem = (function (_Component) {
	    _inherits(InboxItem, _Component);

	    function InboxItem(props, context) {
	        _classCallCheck(this, InboxItem);

	        _get(Object.getPrototypeOf(InboxItem.prototype), 'constructor', this).call(this, props, context);
	    ...
	    _createClass(InboxItem, [{
	        ...
	        value: function render() {
	            ...
	            var mailTitle = _props.mailTitle;
	            var mailMessage = _props.mailMessage;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InboxItem = __webpack_require__(118);
	...
	function InboxList(props) {
	    return _react2['default'].createElement(
	        'ul',
	        { className: 'mail-list' },
	        props.emails.map(function (mail) {
	            return _react2['default'].createElement(_InboxItem2['default'], _extends({}, mail, { key: mail.id }));
	        })
	    );
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Inbox = __webpack_require__(117);
	...
	function Main(props) {
	    ...
	    var segment = route.name.split('.')[0];

	    return (0, _react.createElement)(components[segment] || _NotFound2['default']);
	}

	exports['default'] = (0, _reactRouter5.routeNode)('')(Main);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Nav(props) {
	    ...
	    return _react2['default'].createElement(
	        ...
	        null,
	        _react2['default'].createElement(
	            _reactRouter5.BaseLink,
	            { router: router, routeName: 'inbox', routeOptions: { reload: true } },
	            'Inbox'
	        ),
	        _react2['default'].createElement(
	            _reactRouter5.BaseLink,
	            { router: router, routeName: 'compose' },
	            'Compose'
	        ),
	        _react2['default'].createElement(
	            _reactRouter5.BaseLink,
	            { router: router, routeName: 'contacts' },
	            'Contacts'
	        )
	    );
	}

	exports['default'] = (0, _reactRouter5.withRoute)(Nav);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BaseLink = function (_Component) {
	    ...
	    function BaseLink(props, context) {
	        ...
	        if (!_this.router.hasPlugin('browserPlugin')) {
	        ...
	        var RouteNode = function (_Component) {
	            ...
	            _createClass(RouteNode, [{
	                ...
	                value: function componentDidMount() {
	                    ...
	                    (0, _utils.ifNot)(this.router.hasPlugin('listenersPlugin'), '[react-router5][routeNode] missing plugin router5-plugin-listeners');
	    ...
	    var ComponentWithRoute = function (_Component) {
	        ...
	        _createClass(ComponentWithRoute, [{
	            ...
	            value: function componentDidMount() {
	                ...
	                (0, _utils.ifNot)(this.router.hasPlugin('listenersPlugin'), '[react-router5][withRoute] missing plugin router5-plugin-listeners');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routeNode = __webpack_require__(111);
	...
	var _routerLifecycle = __webpack_require__(219);
	...
	var _routeLifecycle = __webpack_require__(218);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createRouter = __webpack_require__(221);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _browser = __webpack_require__(225);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _resolve = __webpack_require__(230);
