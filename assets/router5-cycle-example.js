...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(79)(module), (function() { return this; }()), __webpack_require__(80)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mockDOMSource = __webpack_require__(28);
	var h = __webpack_require__(11);
	var hh = __webpack_require__(32)(h);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VirtualNode = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pathParser = __webpack_require__(89);

	var _pathParser2 = _interopRequireDefault(_pathParser);

	var _searchParams = __webpack_require__(90);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VDOM = {
	  ...
	  parse: typeof window !== "undefined" ? __webpack_require__(34) : function () {}
	};
	...
	try {
	  matchesSelector = __webpack_require__(33);
	} catch (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SVGAttributeNamespace = __webpack_require__(61);
	var attributeHook = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var propertyMap = __webpack_require__(36);
	var namespaceMap = __webpack_require__(35);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var propConfig = __webpack_require__(46);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var attrHook = __webpack_require__(18);
	var paramCase = __webpack_require__(44);
	var createAttribute = __webpack_require__(37);
	var voidElements = __webpack_require__(47);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var lowerCase = __webpack_require__(39)

	var NON_WORD_REGEXP = __webpack_require__(42)
	var CAMEL_CASE_REGEXP = __webpack_require__(41)
	var TRAILING_DIGIT_REGEXP = __webpack_require__(43)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sentenceCase = __webpack_require__(40)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cycleDom = __webpack_require__(3);
	...
	function Compose(sources) {
	    var initialState = { title: '', message: '' };

	    var title$ = sources.DOM.select('.mail-title').events('input').map(function (evt) {
	        return evt.target.value;
	    });

	    var message$ = sources.DOM.select('.mail-message').events('input').map(function (evt) {
	        return evt.target.value;
	    });

	    var messageAndTitle$ = _rx2['default'].Observable.combineLatest(title$.startWith(''), message$.startWith(''), function (title, message) {
	        return { title: title, message: message };
	    });

	    var compose$ = _rx2['default'].Observable.combineLatest(messageAndTitle$, sources.router.error$.filter(function (err) {
	        return err && err.code === 'CANNOT_DEACTIVATE';
	    }).startWith(''), function (_ref, routerError) {
	        var title = _ref.title;
	        var message = _ref.message;
	        return (0, _cycleDom.div)({ className: 'compose' }, [(0, _cycleDom.h4)('Compose a new message'), (0, _cycleDom.input)({ className: 'mail-title', name: 'title', value: title }), (0, _cycleDom.textarea)({ className: 'mail-message', name: 'message', value: message }), routerError ? (0, _cycleDom.p)('Clear inputs before continuing') : null]);
	    });

	    return {
	        DOM: compose$,
	        router: messageAndTitle$.map(function (_ref2) {
	            var message = _ref2.message;
	            var title = _ref2.title;
	            return ['canDeactivate', 'compose', !message && !title];
	        }).distinctUntilChanged(function (_) {
	            return _[2];
	        })
	    };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InboxList = __webpack_require__(66);
	...
	function Inbox(sources) {
	    var emails$ = _rx2['default'].Observable.combineLatest(sources.router.routeNode$('inbox'), sources.data.emails$, function (route, emails) {
	        var email = route.name === 'inbox.message' ? emails.find(function (_ref) {
	            var id = _ref.id;
	    ...
	    var inbox$ = emails$.map(function (_ref2) {
	        var emails = _ref2.emails;
	        var email = _ref2.email;

	        var inboxList = (0, _InboxList2['default'])({ emails: emails, buildUrl: sources.router.buildUrl });
	        var message = email && (0, _Message2['default'])({ email: email });

	        return (0, _cycleDom.div)({ className: 'inbox' }, [inboxList, message]);
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function InboxList(_ref) {
	    ...
	    var buildUrl = _ref.buildUrl;

	    return (0, _cycleDom.ul)({ className: 'mail-list' }, [emails.map(function (_ref2) {
	        var id = _ref2.id;
	        var mailTitle = _ref2.mailTitle;
	        var mailMessage = _ref2.mailMessage;
	        return (0, _cycleDom.li)((0, _cycleDom.a)({ href: buildUrl('inbox.message', { id: id }) }, [(0, _cycleDom.h4)(mailTitle), (0, _cycleDom.p)(mailMessage)]));
	    })]);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _router5Helpers = __webpack_require__(77);
	...
	function Main(sources) {
	    var routerSource = sources.router;

	    var routeComponent$ = routerSource.routeNode$('').map(function (route) {
	        var startsWith = (0, _router5Helpers.startsWithSegment)(route);

	        if (startsWith('inbox')) {
	            return (0, _Inbox2['default'])(sources);
	        }

	        if (startsWith('compose')) {
	            return (0, _Compose2['default'])(sources);
	        }

	        return {
	            DOM: _rx2['default'].Observable.of((0, _cycleDom.div)('Route component not implemented'))
	        };
	    });

	    return {
	        DOM: routeComponent$.flatMapLatest(function (component) {
	            return component.DOM;
	        }),
	        router: routeComponent$.flatMapLatest(function (component) {
	            return component.router || _rx2['default'].Observable.empty();
	        })
	    };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Message(_ref) {
	    ...
	    return (0, _cycleDom.h)('section', { className: 'mail' }, [(0, _cycleDom.h4)(email.mailTitle), (0, _cycleDom.p)(email.mailMessage)]);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Nav(sources) {
	    ...
	    var nav$ = routerSource.route$.map(function (route) {
	        return (0, _cycleDom.h)('nav', [(0, _cycleDom.a)({ href: sources.router.buildUrl('inbox'), className: routerSource.isActive('inbox') ? 'active' : '' }, 'Inbox'), (0, _cycleDom.a)({ href: sources.router.buildUrl('compose'), className: routerSource.isActive('compose') ? 'active' : '' }, 'Compose')]);
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _router5 = __webpack_require__(88);

	var _router52 = _interopRequireDefault(_router5);

	var _router5PluginsBrowser = __webpack_require__(92);
	...
	var configureRouter = function configureRouter(routes) {
	    return (0, _router52['default'])(routes, {
	        defaultRoute: 'inbox'
	    }).usePlugin(_router5.loggerPlugin).usePlugin((0, _router5PluginsBrowser2['default'])({
	        useHash: true
	    }));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cycleCore = __webpack_require__(26);
	...
	var _router5Driver = __webpack_require__(73);

	var _router5Driver2 = _interopRequireDefault(_router5Driver);

	var _createRouter = __webpack_require__(70);
	...
	var _dataEmails = __webpack_require__(71);

	var _dataEmails2 = _interopRequireDefault(_dataEmails);

	var _componentsNav = __webpack_require__(69);

	var _componentsNav2 = _interopRequireDefault(_componentsNav);

	var _componentsMain = __webpack_require__(67);

	var _componentsMain2 = _interopRequireDefault(_componentsMain);

	var _router5LinkOnClick = __webpack_require__(74);

	function main(sources) {
	    var navigationInstruction$ = _rx2['default'].Observable.fromEvent(document, 'click', 'a').filter((0, _router5LinkOnClick.shouldInterceptEvent)(sources.router))
	    // .map(_ => console.log(_) && _)
	    .map((0, _router5LinkOnClick.onClick)(sources.router));

	    var navSinks = (0, _componentsNav2['default'])(sources);
	    var nav$ = navSinks.DOM.startWith();
	    // const nav$ = Rx.Observable.of('Nav');

	    var mainSinks = (0, _componentsMain2['default'])(sources);
	    var main$ = mainSinks.DOM;
	    var routerInstructions$ = mainSinks.router;

	    var vtree$ = _rx2['default'].Observable.combineLatest(nav$, main$, function (nav, main) {
	        return (0, _cycleDom.div)('.mail-client', [(0, _cycleDom.h)('aside', nav), (0, _cycleDom.h)('main', main)]);
	    });

	    return {
	        DOM: vtree$,
	        router: _rx2['default'].Observable.merge(navigationInstruction$, routerInstructions$)
	    };
	}
	...
	function makeDataDriver() {
	    return function () {
	        return {
	            emails$: _rx2['default'].Observable.of(_dataEmails2['default'])
	        };
	    };
	}
	...
	_cycleCore2['default'].run(main, {
	    ...
	    router: (0, _router5Driver2['default'])((0, _createRouter2['default'])(_routes2['default'])),
	    data: makeDataDriver()
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _router5TransitionPath = __webpack_require__(78);

	var _router5TransitionPath2 = _interopRequireDefault(_router5TransitionPath);

	var _routerToObservable = __webpack_require__(75);

	var _routerToObservable2 = _interopRequireDefault(_routerToObservable);

	var sourceMethods = ['getState', 'buildUrl', 'buildPath', 'matchUrl', 'matchPath', 'areStatesDescendants', 'isActive'];
	var sinkMethods = ['cancel', 'start', 'stop', 'navigate', 'canActivate', 'canDeactivate'];
	 ...
	 */
	var normaliseRequest = function normaliseRequest(req) {
	    var normReq = Array.isArray(req) || typeof req === 'string' ? [].concat(req) : [];

	    if (sinkMethods.indexOf(normReq[0]) === -1) {
	        throw new Error('A Router5 sink argument should be a string (method name) or' + ' an object which first element is a valid metod name, followed by its arguments.' + ' Available sink methods are: ' + sinkMethods.join(',') + '.');
	    }
	 ...
	 */
	var makeRouterDriver = function makeRouterDriver(router) {
	    var autostart = arguments.length <= 1 || arguments[1] === undefined ? true : arguments[1];

	    var startRouter = function startRouter() {
	        return !router.started && autostart && router.start();
	    };

	    // Observe router transitions
	    var transition$ = (0, _routerToObservable2['default'])(router, startRouter);

	    // Helpers
	    var filter = function filter(type) {
	        return transition$.filter(function (_) {
	            return _.type === type;
	        });
	    };
	    var slice = function slice(type) {
	        return filter(type).map(function (_) {
	            return _.type;
	        });
	    };
	    var sliceSlate = function sliceSlate(type) {
	        return filter(type).map(function (_ref) {
	            var toState = _ref.toState;
	            var fromState = _ref.fromState;
	            return { toState: toState, fromState: fromState };
	        });
	    };
	    ...
	    // Transition Route
	    var transitionRoute$ = transition$.map(function (_) {
	        return _.type === 'transitionStart' ? _.toState : null;
	    }).startWith(null);

	    // Error
	    var error$ = transition$.map(function (_) {
	        return _.type === 'transitionError' ? _.error : null;
	    }).startWith(null);

	    var routeState$ = observables.transitionSuccess$.filter(function (_ref2) {
	        ...
	        return { intersection: intersection, route: toState };
	    });

	    // Create a route observable
	    var route$ = routeState$.map(function (_ref4) {
	        var route = _ref4.route;
	        return route;
	    }).startWith(router.getState());

	    // Create a route node observable
	    var routeNode$ = function routeNode$(node) {
	        return routeState$.filter(function (_ref5) {
	            var intersection = _ref5.intersection;
	            return intersection === node;
	        }).map(function (_ref6) {
	            var route = _ref6.route;
	            return route;
	        }).startWith(router.getState()).filter(function (route) {
	            return route !== null;
	        });
	    };

	    // Source API methods ready to be consumed
	    var sourceApi = sourceMethods.reduce(function (methods, method) {
	        return _extends({}, methods, _defineProperty({}, method, function () {
	    ...
	    return function (request$) {
	        request$.map(normaliseRequest).subscribe(function (_ref7) {
	            var _ref72 = _toArray(_ref7);

	            var method = _ref72[0];

	            var args = _ref72.slice(1);
	        ...
	        return _extends({}, sourceApi, observables, {
	            route$: route$,
	            routeNode$: routeNode$,
...
/***/ function(module, exports) {
	...
	var which = function which() {
	    var evt = arguments.length <= 0 || arguments[0] === undefined ? window.event : arguments[0];
	...
	var shouldInterceptEvent = function shouldInterceptEvent(router) {
	    return function (evt) {
	...
	exports.shouldInterceptEvent = shouldInterceptEvent;
	var onClick = function onClick(router) {
	    return function (evt) {
	        var el = evt.target;
	        while (el && 'A' !== el.nodeName) el = el.parentNode;
	        var routeMatch = router.matchUrl(el.href);
...
/***/ function(module, exports) {
	...
	var routerToObservable = function routerToObservable(router, onCreate) {
	    return Rx.Observable.create(function (observer) {
	        var pushState = function pushState(type, isError) {
	            return function (toState, fromState) {
	                var routerEvt = { type: type, toState: toState, fromState: fromState };
	                observer.onNext(isError ? _extends({}, routerEvt, { error: arguments[2] }) : routerEvt);
	            };
	        };
	        var push = function push(type) {
	            return function () {
	                return observer.onNext({ type: type });
	            };
	        };

	        // A Router5 plugin to push any router event to the observer
	        var cyclePlugin = function cyclePlugin() {
	            return {
	                name: 'CYCLE_DRIVER',
	                onStart: push('start'),
	                onStop: push('stop'),
	...
	exports['default'] = routerToObservable;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routeNode = __webpack_require__(23);
	...
	var _routerLifecycle = __webpack_require__(85);
	...
	var _routeLifecycle = __webpack_require__(84);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createRouter = __webpack_require__(87);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _resolve = __webpack_require__(96);
